...
PRIME_MEMBERS_LOGS = int(environ.get('PRIME_MEMBERS_LOGS', "-1002651854723"))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moxi_movies_grp')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Join Channel @moxi_movies \n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','iitsme2807') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','moxi_movies') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','moxi_movies') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','moxibeatz06')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "moxi_movies_grp") #[ without @ ]
...
CAPTION_BUTTON_URL = "https://t.me/moxi_movies"
